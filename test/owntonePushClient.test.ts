import { OwnTonePushClient, type OwnTonePushClientOptions, type WebSocketCtor, type WebSocketLike } from '../src/owntonePushClient';
...
describe('OwnTonePushClient — connecting', () => {
  ...
  it('logs once, at info level, the first time it connects', () => {
    ...
    // Reconnecting logs at debug, not another info line.
    expect(log.info).toHaveBeenCalledTimes(1);
  });
});
